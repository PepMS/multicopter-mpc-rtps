...
/*!
 * @file vehicle_odometryPubSubTypes.h
...
#ifndef _VEHICLE_ODOMETRY_PUBSUBTYPES_H_
#define _VEHICLE_ODOMETRY_PUBSUBTYPES_H_
...
#error Generated vehicle_odometry is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
 ...
 */
class vehicle_odometryPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef vehicle_odometry type;

    eProsima_user_DllExport vehicle_odometryPubSubType();

    eProsima_user_DllExport virtual ~vehicle_odometryPubSubType();
...
#endif // _VEHICLE_ODOMETRY_PUBSUBTYPES_H_