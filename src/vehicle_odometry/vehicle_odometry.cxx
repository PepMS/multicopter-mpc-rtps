...
vehicle_odometry::vehicle_odometry()
{
    ...
    m_timestamp_ = 0;
    // m_local_frame_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7ce6a65d
    m_local_frame_ = 0;
    // m_x_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1500955a
    m_x_ = 0.0;
    // m_y_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@e874448
    m_y_ = 0.0;
    // m_z_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@29b5cd00
    m_z_ = 0.0;
    // m_q com.eprosima.idl.parser.typecode.AliasTypeCode@7113b13f
    memset(&m_q, 0, (4) * 4);
    // m_q_offset com.eprosima.idl.parser.typecode.AliasTypeCode@7113b13f
    memset(&m_q_offset, 0, (4) * 4);
    // m_pose_covariance com.eprosima.idl.parser.typecode.AliasTypeCode@45820e51
    memset(&m_pose_covariance, 0, (21) * 4);
    // m_vx_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@42d8062c
    m_vx_ = 0.0;
    // m_vy_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6043cd28
    m_vy_ = 0.0;
    // m_vz_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@cb51256
    m_vz_ = 0.0;
    // m_rollspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@59906517
    m_rollspeed_ = 0.0;
    // m_pitchspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5bfbf16f
    m_pitchspeed_ = 0.0;
    // m_yawspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@25af5db5
    m_yawspeed_ = 0.0;
    // m_velocity_covariance com.eprosima.idl.parser.typecode.AliasTypeCode@45820e51
 ...
 */
void vehicle_odometry::local_frame_(uint8_t _local_frame_)
{
 ...
 */
uint8_t vehicle_odometry::local_frame_() const
{
 ...
 */
uint8_t& vehicle_odometry::local_frame_()
{
    return m_local_frame_;
}
 ...
 */
void vehicle_odometry::x_(float _x_)
{
m_x_ = _x_;
}
 ...
 */
float vehicle_odometry::x_() const
{
    return m_x_;
}
 ...
 */
void vehicle_odometry::y_(float _y_)
{
m_y_ = _y_;
}
 ...
 */
float vehicle_odometry::y_() const
{
    return m_y_;
}
 ...
 */
void vehicle_odometry::z_(float _z_)
{
m_z_ = _z_;
}
 ...
 */
float vehicle_odometry::z_() const
{
    return m_z_;
}
 ...
 */
void vehicle_odometry::q_offset(const vehicle_odometry__float_array_4 &_q_offset)
{
 ...
 */
void vehicle_odometry::q_offset(vehicle_odometry__float_array_4 &&_q_offset)
{
 ...
 */
const vehicle_odometry__float_array_4& vehicle_odometry::q_offset() const
{
    return m_q_offset;
}
 ...
 */
vehicle_odometry__float_array_4& vehicle_odometry::q_offset()
{
    return m_q_offset;
}
/*!
 ...
 */
void vehicle_odometry::pose_covariance(const vehicle_odometry__float_array_21 &_pose_covariance)
{
 ...
 */
void vehicle_odometry::pose_covariance(vehicle_odometry__float_array_21 &&_pose_covariance)
{
 ...
 */
const vehicle_odometry__float_array_21& vehicle_odometry::pose_covariance() const
{
 ...
 */
vehicle_odometry__float_array_21& vehicle_odometry::pose_covariance()
{
    return m_pose_covariance;
}
/*!
 ...
 */
void vehicle_odometry::vx_(float _vx_)
{
m_vx_ = _vx_;
}
 ...
 */
float vehicle_odometry::vx_() const
{
    return m_vx_;
}
 ...
 */
void vehicle_odometry::vy_(float _vy_)
{
m_vy_ = _vy_;
}
 ...
 */
float vehicle_odometry::vy_() const
{
    return m_vy_;
}
 ...
 */
void vehicle_odometry::vz_(float _vz_)
{
m_vz_ = _vz_;
}
 ...
 */
float vehicle_odometry::vz_() const
{
    return m_vz_;
}
 ...
 */
void vehicle_odometry::rollspeed_(float _rollspeed_)
{
 ...
 */
float vehicle_odometry::rollspeed_() const
{
    return m_rollspeed_;
}
 ...
 */
float& vehicle_odometry::rollspeed_()
{
    return m_rollspeed_;
}
 ...
 */
void vehicle_odometry::pitchspeed_(float _pitchspeed_)
{
 ...
 */
float vehicle_odometry::pitchspeed_() const
{
 ...
 */
float& vehicle_odometry::pitchspeed_()
{
    return m_pitchspeed_;
}
 ...
 */
void vehicle_odometry::yawspeed_(float _yawspeed_)
{
 ...
 */
float vehicle_odometry::yawspeed_() const
{
    return m_yawspeed_;
}
 ...
 */
float& vehicle_odometry::yawspeed_()
{
    return m_yawspeed_;
}
 ...
 */
void vehicle_odometry::velocity_covariance(const vehicle_odometry__float_array_21 &_velocity_covariance)
{
 ...
 */
void vehicle_odometry::velocity_covariance(vehicle_odometry__float_array_21 &&_velocity_covariance)
{
 ...
 */
const vehicle_odometry__float_array_21& vehicle_odometry::velocity_covariance() const
{
 ...
 */
vehicle_odometry__float_array_21& vehicle_odometry::velocity_covariance()
{
    return m_velocity_covariance;
}
